export const translations = {
  en: {
    ...
    home: {
      ...
      testimonialsDesc: 'Read authentic experiences from patients who have received world-class care at our hospital. Also explore our FAQ section for answers to common questions.',
  ...
  te: {
    ...
    home: {
      ...
      testimonialsDesc: 'మా ఆసుపత్రిలో ప్రపంచ-స్థాయి సంరక్షణ పొందిన రోగుల నుండి ప్రామాణిక అనుభవాలను చదవండి. సాధారణ ప్రశ్నలకు సమాధానాల కోసం మా FAQ విభాగాన్ని కూడా అన్వేషించండి.',
