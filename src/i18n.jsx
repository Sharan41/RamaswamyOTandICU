export const translations = {
  en: {
    brand: 'Dr. Ramaswamy Hospitals - OT and ICU Care',
    nav: {
      home: 'Home',
      about: 'About',
    ...
    home: {
      tagline: '<strong>Nellore\'s first non-consultation hospital</strong>, designed for <strong>doctors</strong> to provide <strong>advanced surgical and critical care</strong> infrastructure with efficiency and excellence for their patients.',
      heroBadge: 'You Operate and We Care !',
      heroWhyChooseTitle: 'Why Choose Us',
      heroWhyChoose1: '24/7 Surgical and Critical Care with affordable cost',
      heroWhyChoose2: 'A ready to use OT & ICU Ecosystem',
      heroWhyChoose3: 'Round the clock Intensivist & Physician',
      heroWhyChoose4: 'All Insurance schemes accepted',
      heroWhyChoose5: 'Designed for seamless integration for visiting consultants',
      heroWhyChooseTagline: 'Because your health deserves the right doctor, at the right place.',
      lookingForOtIcu: 'Looking for OT and ICU Care?',
      lookingForOtIcuSubtitle: 'A collaborative plug and play concept enabled for consulting Surgeons and Physicians',
      lookingForOtIcuDesc: 'At Dr. Ramaswamy Hospitals – OT & ICU, we provide a safe, fully equipped surgical ecosystem where patients receive quality care and doctors practice with confidence.',
      lookingForOtIcuFeature1: 'Modern Operation Theatres',
      lookingForOtIcuFeature2: 'Well-equipped Intensive Care Units',
      ...
      experiencedTeamDesc: 'At Dr. Ramaswamy Hospitals, our strength lies in our team of <strong>highly qualified and experienced medical professionals</strong> who are dedicated to delivering exceptional patient care. From skilled technicians and compassionate nurses and support staff, every member of our team works with commitment, precision, and empathy. With years of hands-on experience and continuous training, our experts ensure that each patient receives the highest standard of treatment, backed by advanced medical technology and personalised attention. Together, we strive to uphold our legacy of trust, care, and excellence in healthcare.',
      emergency247: '24/7 Emergency Care',
      emergency247Desc: 'Our emergency team is <strong>always ready—day or night—</strong>to provide swift, expert care when it matters most. With skilled technicians and compassionate nurses, and advanced facilities, we\'re here every moment to save lives and support patients in critical times.',
      patientCentered: 'Patient Centred Approach',
      patientCenteredDesc: 'Our team is dedicated to delivering care that truly revolves around our patients. <strong>We listen, understand, and work together</strong> to provide compassionate, personalised treatment that ensures comfort and trust at every step.',
      affordableCare: 'Affordable Care',
      affordableCareDesc: 'The team is dedicated to providing quality treatment at a <strong>cost one can afford.</strong> We combine compassion, expertise, and care to ensure every patient receives the best without financial burden.',
      ...
      testimonialsBadge: 'Doctor Stories',
      testimonialsTitle: 'Trusted by Doctors',
      testimonialsDesc: 'Read authentic experiences from Doctors who have operated in our facility.',
    ...
    about: {
      title: 'About Us',
      intro1: 'Dr. Ramaswamy Hospitals is <strong>Nellore\'s first Non Consultation Hospital</strong>, founded by Kavali\'s first Orthopaedic Surgeon with a record of over <strong>50,000 successful surgeries</strong>. Guided by strong ethics and compassion, we continue our mission to provide <strong>quality, affordable, and patient-focused care</strong> to every individual who walks through our doors.',
      intro2: '',
      mission: 'Our Mission',
      missionText: '<strong>You Operate and We Care.</strong> We are committed to providing <strong>high-quality, affordable healthcare</strong> for everyone. Our focus is on delivering <strong>advanced medical care</strong> with compassion, ensuring safety, comfort, and excellence. We value every patient\'s trust and feedback as we continue to improve our services. With <strong>ethics and empathy</strong> at our core.',
      vision: 'Vision',
      visionText: 'To be the <strong>leading facilities provider</strong> for recognised surgeons and for <strong>exceptional medical care</strong> for their patients.',
      motto: 'Motto',
      mottoText: '<strong>You Operate and We Care.</strong> We are dedicated to providing <strong>high-quality healthcare</strong> to every patient, offering <strong>compassionate support</strong> to those in need, and continuously improving our services based on patient feedback.',
      ...
      directorEducation: 'BBA ; M.Sc Enterprise in Entrepreneurship, UK',
      ...
      rakshanaBio: 'Rakshana oversees the operational and digital presence of Dr. Ramaswamy Hospitals. With a focus on <strong>designing and patient engagement</strong>, she ensures that the hospital\'s services run seamlessly while <strong>strengthening its online visibility</strong>. Through her leadership in digital marketing and operations, she plays a key role in connecting <strong>the hospital\'s mission of compassionate, quality healthcare</strong> with the community it serves.',
    ...
    testimonials: {
      ...
      subtitle: 'Read authentic experiences from doctors who have operated in our facility.',
      happyPatients: 'Happy Doctors',
      ...
      whatPatientsSay: 'What Our Doctors Say',
    ...
    achievements: {
      ...
      // Achievement 17: Osteoid Osteoma
      osteoidOsteomaTitle: 'Successful Osteoid Osteoma Excision',
      osteoidOsteomaDesc: 'Our team successfully performed a complex orthopedic surgery on a 17-year-old boy suffering from severe persistent leg pain. An MRI revealed an osteoid osteoma of the femur — a lytic lesion with a nidus on the medial shaft. We performed complete excision of the bone tumor, followed by fibular bone grafting and G-bone placement to ensure stability. The surgery was a complete success, and the patient tolerated the procedure well, restoring hope and health.',
    ...
    doctors: {
      ...
      // Dr. Rasi Veeraiah Goud
      drRasiVeeraiahGoudName: 'Dr. Rasi Veeraiah Goud',
      drRasiVeeraiahGoudSpecialty: 'Urologist',
      drRasiVeeraiahGoudBio: 'Specialist in Urology with expertise in general surgery, dedicated to comprehensive urological care.',
      drRasiVeeraiahGoudEducation: 'MBBS., MS (Gen. Surg.), Mch (Urology)',
      drRasiVeeraiahGoudSpec1: 'Urology',
      drRasiVeeraiahGoudSpec2: 'General Surgery',
    ...
    otIcuCare: {
      ...
      whyChoose2: 'A ready to use OT & ICU Ecosystem',
      whyChoose3: 'Round the clock Intensivist & Physician',
      whyChoose4: 'All Insurance schemes accepted',
      whyChoose5: 'Designed for seamless integration for visiting consultants',
      ourSpecialities: 'Our Specialities:',
      speciality1: 'Day Care OT & ICU\'s',
      speciality2: 'IP Admissions',
      speciality3: 'Orthopedics',
      speciality4: 'Spine Surgeries',
      speciality5: 'Urology',
      speciality6: 'Gynecology & Obstetrics',
      speciality7: 'Surgical Gastro',
      speciality8: 'ENT',
      speciality9: 'General Surgery',
      speciality10: 'Proctology',
  ...
  te: {
    brand: 'డాక్టర్. రామస్వామి హాస్పిటల్స్ - OT మరియు ICU కేర్',
    nav: {
      home: 'హోమ్',
      about: 'గురించి',
      services: 'ప్రత్యేకతలు',
      blogs: 'బ్లాగులు',
      doctors: 'వైద్యులు',
      facilities: 'సౌకర్యాలు',
      otIcuCare: 'కన్సల్టేషన్',
    ...
    home: {
      tagline: '<strong>నెల్లూరులో మొదటిదైన కన్సల్టేషన్ లేని హాస్పిటల్</strong>, <strong>వైద్యులు</strong> తమ రోగుల కోసం <strong>అధునాతన శస్త్రచికిత్స మరియు క్లిష్టమైన సంరక్షణ</strong> మౌలిక సదుపాయాలను సమర్థవంతంగా మరియు శ్రేష్ఠతతో అందించేలా రూపొందించబడింది.',
      heroBadge: 'మీరు ఆపరేట్ చేస్తారు, మేము సంరక్షిస్తాము !',
      heroWhyChooseTitle: 'మమ్మల్ని ఎందుకు ఎంచుకోవాలి',
      heroWhyChoose1: 'సరసమైన ఖర్చుతో 24/7 శస్త్రచికిత్స మరియు క్లిష్టమైన సంరక్షణ',
      heroWhyChoose2: 'వెంటనే ఉపయోగించదగిన OT & ICU ఎకోసిస్టమ్',
      heroWhyChoose3: 'గడియారపు ఇంటెన్సివిస్ట్ & ఫిజిషియన్',
      heroWhyChoose4: 'అన్ని విమా పథకాలు అంగీకరించబడ్డాయి',
      heroWhyChoose5: 'సందర్శన కన్సల్టెంట్‌ల కోసం సజావుగా ఏకీకరణ కోసం రూపొందించబడింది',
      heroWhyChooseTagline: 'మీ ఆరోగ్యానికి సరైన వైద్యుడు, సరైన ప్రదేశంలో అర్హత ఉంది.',
      lookingForOtIcu: 'OT మరియు ICU కేర్ కోసం చూస్తున్నారా?',
      lookingForOtIcuSubtitle: 'కన్సల్టింగ్ సర్జన్‌లు మరియు ఫిజిషియన్‌ల కోసం ప్రారంభించబడిన సహకార ప్లగ్ అండ్ ప్లే భావన',
      lookingForOtIcuDesc: 'డాక్టర్ రామస్వామి హాస్పిటల్స్ – OT & ICUలో, మేము సురక్షితమైన, పూర్తిగా సన్నద్ధమైన శస్త్రచికిత్స ఎకోసిస్టమ్‌ను అందిస్తాము, ఇక్కడ రోగులు నాణ్యమైన సంరక్షణను పొందుతారు మరియు వైద్యులు నమ్మకంతో అభ్యాసం చేస్తారు.',
      lookingForOtIcuFeature1: 'ఆధునిక ఆపరేషన్ థియేటర్లు',
      lookingForOtIcuFeature2: 'బాగా సన్నద్ధమైన ఇంటెన్సివ్ కేర్ యూనిట్‌లు',
      ...
      followYouTube: 'యూట్యూబ్‌లో మమ్మల్ని అనుసరించండి',
      ...
      testimonialsBadge: 'డాక్టర్ కథలు',
      testimonialsTitle: 'వైద్యులు విశ్వసించారు',
      testimonialsDesc: 'మా సౌకర్యంలో ఆపరేట్ చేసిన వైద్యుల నుండి ప్రామాణిక అనుభవాలను చదవండి.',
    ...
    about: {
      title: 'మా గురించి',
      intro1: 'డాక్టర్ రామస్వామి హాస్పిటల్స్ <strong>నెల్లూరులో మొదటిదైన కన్సల్టేషన్ లేని హాస్పిటల్</strong>, కావలి యొక్క మొదటి ఆర్థోపెడిక్ సర్జన్ చేత స్థాపించబడింది, <strong>50,000 విజయవంతమైన శస్త్రచికిత్సలకు</strong> పైగా రికార్డుతో. బలమైన నైతికత మరియు కరుణతో మార్గదర్శకత్వం, మేము మా తలుపుల గుండా నడిచే ప్రతి వ్యక్తికి <strong>నాణ్యత, సరసమైన మరియు రోగి-కేంద్రీకృత సంరక్షణను</strong> అందించే మా లక్ష్యాన్ని కొనసాగిస్తాము.',
      intro2: '',
      mission: 'మా లక్ష్యం',
      missionText: '<strong>మీరు ఆపరేట్ చేస్తారు, మేము సంరక్షిస్తాము.</strong> మేము అందరికీ <strong>అధిక-నాణ్యత, సరసమైన ఆరోగ్య సంరక్షణను</strong> అందించడానికి కట్టుబడి ఉన్నాము. మా దృష్టి <strong>కరుణతో అధునాతన వైద్య సంరక్షణను</strong> అందించడం, భద్రత, సౌకర్యం మరియు శ్రేష్ఠతను నిర్ధారించడం. మేము మా సేవలను మెరుగుపరుస్తూ ప్రతి రోగి యొక్క నమ్మకం మరియు అభిప్రాయాన్ని విలువైనదిగా భావిస్తాము. <strong>నైతికత మరియు సానుభూతి</strong> మా ప్రధానంగా.',
      vision: 'దృష్టి',
      visionText: 'గుర్తింపు పొందిన సర్జన్లకు మరియు వారి రోగులకు <strong>అసాధారణమైన వైద్య సంరక్షణ</strong> కోసం <strong>అగ్రగామి సదుపాయాల ప్రదాతగా</strong> ఉండటం.',
      motto: 'నినాదం',
      mottoText: '<strong>మీరు ఆపరేట్ చేస్తారు, మేము సంరక్షిస్తాము.</strong> మేము ప్రతి రోగికి <strong>అధిక-నాణ్యత ఆరోగ్య సంరక్షణను</strong> అందించడానికి, అవసరంలో ఉన్నవారికి <strong>కరుణామయ మద్దతును</strong> అందించడానికి మరియు రోగుల అభిప్రాయం ఆధారంగా మా సేవలను నిరంతరం మెరుగుపరచడానికి అంకితం చేయబడ్డాము.',
      ...
      rakshanaName: 'Mrs. మాంచికంటి రక్షణ సౌరవ్',
      rakshanaTitle: 'ఆపరేషన్స్ డైరెక్టర్',
      rakshanaEducation: 'B. Com A&F ; Fashion Designing',
      rakshanaBio: 'రక్షణ డాక్టర్ రామస్వామి హాస్పిటల్స్ యొక్క కార్యాచరణ మరియు డిజిటల్ ప్రసిద్ధిని పర్యవేక్షిస్తుంది. <strong>డిజైనింగ్ మరియు రోగి నిశ్చితత్వం</strong>పై దృష్టి సారించడంతో, ఆసుపత్రి సేవలు సజావుగా నడుస్తున్నాయని మరియు దాని <strong>ఆన్‌లైన్ దృశ్యమానతను బలోపేతం</strong> చేస్తున్నదని ఆమె నిర్ధారిస్తుంది. డిజిటల్ మార్కెటింగ్ మరియు కార్యాచరణలలో ఆమె నాయకత్వం ద్వారా, <strong>ఆసుపత్రి యొక్క కరుణామయ, నాణ్యమైన ఆరోగ్య సంరక్షణ</strong> యొక్క లక్ష్యాన్ని అది సేవలు అందించే సమాజంతో కలుపుతున్నందులో ఆమె కీలక పాత్ర పోషిస్తుంది.',
    ...
    testimonials: {
      title: 'డాక్టర్ ప్రశంసలు',
      subtitle: 'మా సౌకర్యంలో ఆపరేట్ చేసిన వైద్యుల నుండి ప్రామాణిక అనుభవాలను చదవండి.',
      happyPatients: 'సంతోషకరమైన వైద్యులు',
      averageRating: 'సగటు రేటింగ్',
      satisfactionRate: 'సంతృప్తి రేటు',
      patientStories: 'డాక్టర్ కథలు',
      ...
      whatPatientsSay: 'మా వైద్యులు ఏమి చెబుతున్నారు',
    ...
    achievements: {
      ...
      // Achievement 17: Osteoid Osteoma
      osteoidOsteomaTitle: 'విజయవంతమైన ఆస్టియాయిడ్ ఆస్టియోమా ఎక్సిషన్',
      osteoidOsteomaDesc: 'మా బృందం తీవ్రమైన నిరంతర కాళ్ళ నొప్పితో బాధపడుతున్న 17 సంవత్సరాల వయస్సులోని అబ్బాయిపై సంక్లిష్టమైన ఆర్థోపెడిక్ శస్త్రచికిత్సను విజయవంతంగా నిర్వహించింది. MRI ఫీమర్ యొక్క ఆస్టియాయిడ్ ఆస్టియోమాను వెల్లడి చేసింది — మీడియల్ షాఫ్ట్‌లో నిడస్‌తో కూడిన లైటిక్ లెషన్. మేము ఎముక ట్యూమర్ యొక్క పూర్తి ఎక్సిషన్‌ను నిర్వహించాము, తర్వాత స్థిరత్వాన్ని నిర్ధారించడానికి ఫిబ్యులర్ ఎముక గ్రాఫ్టింగ్ మరియు G-ఎముక ప్లేస్‌మెంట్ చేసాము. శస్త్రచికిత్స పూర్తి విజయం సాధించింది మరియు రోగి ప్రక్రియను బాగా సహించాడు, ఆశ మరియు ఆరోగ్యాన్ని పునరుద్ధరించాడు.',
    ...
    doctors: {
      ...
      // డా. రాసి వీరయ్య గౌడ్
      drRasiVeeraiahGoudName: 'డా. రాసి వీరయ్య గౌడ్',
      drRasiVeeraiahGoudSpecialty: 'యూరాలజిస్ట్',
      drRasiVeeraiahGoudBio: 'సాధారణ శస్త్రచికిత్సలో నైపుణ్యంతో యూరాలజీలో నిపుణుడు, సమగ్ర మూత్రవిజ్ఞాన సంరక్షణకు అంకితం.',
      drRasiVeeraiahGoudEducation: 'ఎం.బి.బి.ఎస్., ఎం.ఎస్. (జనరల్ సర్జ్.), ఎం.చ్ (యూరాలజీ)',
      drRasiVeeraiahGoudSpec1: 'యూరాలజీ',
      drRasiVeeraiahGoudSpec2: 'సాధారణ శస్త్రచికిత్స',
    ...
    otIcuCare: {
      ...
      whyChoose2: 'వెంటనే ఉపయోగించదగిన OT & ICU ఎకోసిస్టమ్',
      whyChoose3: 'గడియారపు ఇంటెన్సివిస్ట్ & ఫిజిషియన్',
      whyChoose4: 'అన్ని విమా పథకాలు అంగీకరించబడ్డాయి',
      whyChoose5: 'సందర్శన కన్సల్టెంట్‌ల కోసం సజావుగా ఏకీకరణ కోసం రూపొందించబడింది',
      ourSpecialities: 'మా ప్రత్యేకతలు:',
      speciality1: 'డే కేర్ OT & ICU\'s',
      speciality2: 'IP ప్రవేశాలు',
      speciality3: 'ఆర్థోపెడిక్స్',
      speciality4: 'వెన్నెముక శస్త్రచికిత్సలు',
      speciality5: 'యూరాలజీ',
      speciality6: 'గైనకాలజీ & ప్రసూతి',
      speciality7: 'శస్త్రచికిత్స గ్యాస్ట్రో',
      speciality8: 'ENT',
      speciality9: 'సాధారణ శస్త్రచికిత్స',
      speciality10: 'ప్రోక్టాలజీ',
      speciality11: 'వారికోస్ సిరలు',
      lookingFor: 'OT మరియు ICU కేర్ కోసం చూస్తున్నారా?',
      lookingForSubtitle: 'కన్సల్టింగ్ సర్జన్‌లు మరియు ఫిజిషియన్‌ల కోసం ప్రారంభించబడిన సహకార ప్లగ్ అండ్ ప్లే భావన',
      description: 'డాక్టర్ రామస్వామి హాస్పిటల్స్ – OT & ICUలో, మేము సురక్షితమైన, పూర్తిగా సన్నద్ధమైన శస్త్రచికిత్స ఎకోసిస్టమ్‌ను అందిస్తాము, ఇక్కడ రోగులు నాణ్యమైన సంరక్షణను పొందుతారు మరియు వైద్యులు నమ్మకంతో అభ్యాసం చేస్తారు.',
      feature1: 'ఆధునిక ఆపరేషన్ థియేటర్లు',
      feature2: 'బాగా సన్నద్ధమైన ఇంటెన్సివ్ కేర్ యూనిట్‌లు',
      feature3: 'అనుభవజ్ఞులైన వైద్య & నర్సింగ్ బృందం',
